...
export const READMEA = {
  ...
  EMBED_MODEL: process.env.READMEA_EMBED_MODEL || 'text-embedding-3-small',
  ...
  LLM_TIMEOUT_MS: Number(process.env.READMEA_LLM_TIMEOUT_MS ?? 20_000),
  LLM_MAX_SECTION_CHARS: Number(process.env.READMEA_LLM_MAX_SECTION_CHARS ?? 600),
